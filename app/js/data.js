...
UNITS[6] = {
  ...
  objectives: [
    ...
    'להשלים כותרת ולכתוב מילים ממשפחות ח־ק־ר, כ־ו־כ ו־ע־ו־פ',
  ...
  parts: [
    ...
    /* ---- 2. משפט אחד: מציאת משפחה ---- */
    {
      type: 'sentence-hunt',
      kicker: 'שלב 2 · משפט ראשון',
      title: 'משפחת כ־ו־כ מתחבאת במשפט!',
      guide: 'מתחילים כרגיל בקטן: משפט אחד בלבד. מסתתרות בו שלוש מילים ממשפחת השורש כ־ו־כ. מצאו את כולן!',
      family: 'כ־ו־כ',
      sceneImage: 'assets/img/unit6-stars.png',
      sceneSvg: 'STARS_SCENE_SVG',
      words: ['בלילה', 'ראינו', 'כוכב', 'אחד', 'זוהר,', 'סביבו', 'נצנצו', 'כוכבים', 'קטנים,', 'ובשמים', 'נמתחה', 'שרשרת', 'של', 'כוכביות.'],
      targetIdx: [2, 7, 13],
      fbGood: 'מצוין! כוכב, כוכבים וכוכביות. שלוש מילים, שורש אחד: כ־ו־כ!',
      fbBad: 'המילה הזו לא ממשפחת כ־ו־כ. חפשו את האותיות כ, ו, כ בתוך המילה 🔎',
    },
    ...
    /* ---- 11. הרחבת משפחות בכתיבה ---- */
    {
      ...
      rounds: [
        ...
        },
        {
          root: 'כ־ו־כ',
          given: ['כוכב', 'כוכבון'],
          ideas: ['כוכבים', 'כוכבית', 'כוכביות'],
          praise: 'מעולה! שרשרת הכוכבים שלכם נמתחת על פני כל השמים!',
        },
        {
          root: 'ע־ו־פ',
          given: ['לעוף', 'תעופה'],
    ...
    /* ---- 14. סיכום ---- */
    {
      ...
      checks: [
        ...
        'כתבתי מילים חדשות ממשפחות ח־ק־ר, כ־ו־כ ו־ע־ו־פ',
      ],
      wordPrompt: 'מילה אחת שאקח איתי מהיחידה:',
    },
  ],

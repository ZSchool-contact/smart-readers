...
UNITS[1] = {
  ...
  topic: 'משחקי מחשב',
  emoji: '🎮',
  bg: 'assets/img/unit1-background.png',       /* רקע איור למסך, מסביב לכרטיס */
  ...
  parts: [
    ...
    /* ---- 4. קטע קצר ---- */
    {
      ...
      guide: 'עכשיו קטע קצרצר, רק שלושה משפטים. הם יופיעו לאט לאט, בקצב שלכם. קראו וסמנו בלחיצה את המשפט שנראה לכם הכי חשוב.',

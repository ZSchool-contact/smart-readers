...
**נושא היחידה:** יחידת הסיום החגיגית! הרפתקת "האי של הסודות" עם נועה מגלת הארצות.
האווירה: חגיגה, ניצחון, גאווה — עם קונפטי ותחושת גמר משחק.
> הערה (1.8): בחירת המסלול הוסרה בפידבק. `unit8-tech.png` ו-`unit8-animals.png`
> נוצרו ונשמרים בריפו, אבל אינם בשימוש כרגע.
